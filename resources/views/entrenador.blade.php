...
<form id="form1" name="form1" method="post" action="{{url('entrenador')}}">
{!!csrf_field()!!}
  <div align="center">
  ...
  <label class="col-md-4 control-label" >Apellido</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="last_name" placeholder="Apellido" class="form-control"  type="text" required="">
    </div>
  </div>
  ...
  <label class="col-md-4 control-label" >Identificacion</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="last_name" placeholder="Identificacion" class="form-control"  type="text" required="">
    </div>
  </div>
